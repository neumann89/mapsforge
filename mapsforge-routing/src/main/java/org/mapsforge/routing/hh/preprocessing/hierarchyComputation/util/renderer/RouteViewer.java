 ...
 */
package org.mapsforge.routing.hh.preprocessing.hierarchyComputation.util.renderer;
...
public class RouteViewer {
	...
	public RouteViewer(Router router) {
        this(router, new GeoPosition(52.6d, 13.4d));
    }

	public RouteViewer(Router router, double centerLatitude, double centerLongitude) {
        this(router, new GeoPosition(centerLatitude, centerLongitude));
    }

	public RouteViewer(Router router, GeoPosition center) {
