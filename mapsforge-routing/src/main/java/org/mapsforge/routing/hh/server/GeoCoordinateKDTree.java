...
import org.mapsforge.routing.hh.preprocessing.hierarchyComputation.HHDbReader.HHVertex;
...
class GeoCoordinateKDTree implements Serializable {
	...
	public static void main(String[] args) throws SQLException {
		...
		RgDAO rg = new RgDAO(DBConnection.getConnectionToPostgreSQL("localhost", 5432, "berlin",
                "postgres", "admin"));
