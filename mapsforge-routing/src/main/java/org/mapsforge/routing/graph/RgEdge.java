...
/**
 * This class implements an Object representation of edges stored in the routing graph db schema.
 */
public class RgEdge implements IRgEdge {

	private final int id, sourceId, targetId, weight;
	 ...
	 */
	public RgEdge(int id, int sourceId, int targetId, int weight, double[] longitudes,
			double[] latitudes,
