...
public final class Deserializer {
	 ...
	 * @return true if bit is set.
	 */
	public static boolean readBit(byte[] buff, Offset offset) {
	 ...
	 * @return the value read.
	 */
	public static byte readByte(byte[] buff, Offset offset) {
		byte val;
	 ...
	 * @return the value read.
	 */
	public static short readShort(byte[] buff, Offset offset) {
		short val;
		if (offset.bitOffset == 0) {
	 ...
	 * @return the value read.
	 */
	public static int readInt(byte[] buff, Offset offset) {
		int val;
		if (offset.bitOffset == 0) {
	 ...
	 * @return the value read.
	 */
	public static int readUInt(byte[] buff, int nBits, Offset offset) {
		int val;
		if (offset.bitOffset == 0) {
			val = ((buff[offset.byteOffset] & 0xff)
					| ((buff[offset.byteOffset + 1] & 0xff) << 8)
