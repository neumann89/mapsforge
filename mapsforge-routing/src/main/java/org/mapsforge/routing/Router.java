 ...
 * routing algorithm for shortest path queries and a graph like interface allowing traversal and querying
 * of vertices' and edges' satellite data.
 */
